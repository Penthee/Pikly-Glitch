...
namespace Pikl.Utils.RDS {
    ...
    public class RDSObject : IRDSObject {
        ...
        /// <summary>
        /// Gets or sets whether this object may be contained in a result set one time
        /// </summary>
        ...
        public string ToString(int indentationlevel) {
            ...
            return string.Format(indent + "(RDSObject){0} Prob:{1},OUAE:{2}{3}{4}{5}",
                this.GetType().Name, rdsProbability,
                (rdsAmount.ToString()), (rdsUnique ? "1" : "0"), (rdsAlways ? "1" : "0"), (rdsEnabled ? "1" : "0"));
        }
        #endregion
    }
}
